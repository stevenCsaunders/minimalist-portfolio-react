...
const SocialIcons = () => {
	...
	useEffect(() => {
		...
		`
			...
			.then((data) => setSocialIconData(data[0]))
			.catch(console.error)
	}, [])
	...
	return (
		<ul>
			{socialIconData.githubIcon.link ? (
				<li>
					<a
						href={socialIconData.githubIcon.link}
						target='_blank'
						rel='noreferrer'
						aria-label={socialIconData.githubIcon.alt}
					>
						<svg
							role='img'
							...
							height='24'
						>
							<title id='github-icon'>
								Github Footer Menu Icon
							</title>
							<path
								fill='#33323D'
			...
			{socialIconData.linkedInIcon.link ? (
				<li>
					<a
						href={socialIconData.linkedInIcon.link}
						target='_blank'
						rel='noreferrer'
						aria-label={socialIconData.linkedInIcon.alt}
					>
						<svg
							role='img'
							...
							height='20'
						>
							<title id='linkedin-icon'>
								Linked In Footer Menu Icon
							</title>
							<path
								fill='#33323D'
			...
			{socialIconData.twitterIcon.link ? (
				<li>
					<a
						href={socialIconData.twitterIcon.link}
						target='_blank'
						rel='noreferrer'
						aria-label={socialIconData.linkedInIcon.alt}
					>
